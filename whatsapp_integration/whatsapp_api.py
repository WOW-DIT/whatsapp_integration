...
def whatsapp_webhook():
    if frappe.request.method == "GET":
        ...
        if mode == "subscribe" and wa_settings.verify_token == verify_token:
...
def send_to_ai(phone_id, business_id, from_number, to_number, message_type, text, image: dict=None):
...
def get_chat(phone_id, business_id, from_number, ai_context):
